...
type AbaConfig = 'MOTO' | 'CATEGORIAS' | 'LANCAMENTOS' | 'SEGURANCA' | 'PLANO' | 'SUPORTE'
...
onMounted(async () => {
  ...
  } else if (route.query.aba === 'SUPORTE') {
    abaAtiva.value = 'SUPORTE'
  }
...
<template>
  ...
  <div class="bg-background text-on-surface font-body min-h-screen">
    <main class="px-5 py-5 lg:px-8 lg:py-6 space-y-4 max-w-4xl mx-auto pb-28 lg:pb-8">
      ...
      <div class="grid grid-cols-3 sm:grid-cols-6 gap-1 font-mono">
        <button
        ...
        <button
          class="h-10 font-label text-[9px] font-bold tracking-widest uppercase border truncate px-1 flex items-center justify-center gap-1"
          :class="abaAtiva === 'SUPORTE' ? 'bg-emerald-500 text-white border-emerald-400 font-bold' : 'bg-emerald-500/10 text-emerald-400 border-emerald-500/30'"
          @click="abaAtiva = 'SUPORTE'"
        >
      ...
      <!-- ── ABA SUPORTE & AJUDA ── -->
      <section v-if="abaAtiva === 'SUPORTE'" class="space-y-4">
        <div class="bg-surface-container-low p-6 rounded-2xl border border-outline-variant/30 space-y-6">
          <div class="flex items-center gap-4">
            ...
            <div>
              <h3 class="text-lg font-headline font-black text-on-surface uppercase">Central de Ajuda & Atendimento</h3>
              <p class="text-xs text-on-surface-variant">Estamos aqui para apoiar seu trabalho diário. Escolha o canal de sua preferência:</p>
            </div>
          </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <a
              href="https://wa.me/5521980115136?text=Ol%C3%A1!%20Preciso%20de%20ajuda%20no%20Gest%C3%A3o%20Motoca."
              target="_blank"
              rel="noopener noreferrer"
              class="group p-5 rounded-xl bg-[#25D366]/10 border border-[#25D366]/30 hover:bg-[#25D366]/20 transition-all flex flex-col justify-between gap-4"
            >
              <div class="flex items-start justify-between">
                <div class="flex items-center gap-3">
                  <div class="w-10 h-10 rounded-lg bg-[#25D366] text-white flex items-center justify-center shadow-md">
                  ...
                  <div>
                    <h4 class="font-bold text-[#25D366] text-sm">Atendimento via WhatsApp</h4>
                    <p class="text-xs font-mono text-on-surface-variant">(21) 98011-5136</p>
                  </div>
                </div>
                <span class="material-symbols-outlined text-xl text-[#25D366] group-hover:translate-x-1 transition-transform">open_in_new</span>
              </div>
              <span class="w-full text-center py-2 px-3 rounded-lg bg-[#25D366] text-slate-950 font-black text-xs uppercase tracking-wider">
                Conversar no WhatsApp
              </span>
            </a>

            <!-- Email Card -->
            <div class="p-5 rounded-xl bg-surface border border-outline-variant/30 flex flex-col justify-between gap-4">
              <div class="flex items-center gap-3">
                ...
                <div>
                  <h4 class="font-bold text-on-surface text-sm">Suporte via E-mail</h4>
                  <p class="text-xs font-mono text-on-surface-variant truncate">joaom3ndes@gmail.com</p>
                </div>
              </div>
              <a
                href="mailto:joaom3ndes@gmail.com"
                class="w-full text-center py-2 px-3 rounded-lg bg-surface-container-high hover:bg-surface-container-highest text-on-surface font-bold text-xs uppercase tracking-wider flex items-center justify-center gap-1.5 transition-colors"
              >
